  ...
  return (
    <div className="flex">
      <div className="flex-1 flex flex-col justify-center items-center md:items-start">
        ...
        <Link to={"/buynow"} className="text-white mt-5 ml-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          Buy Now
        </Link>
      </div>
