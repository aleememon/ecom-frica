...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full flex justify-between items-center p-6 bg-white shadow-md z-50 text-[#143A51]">
      {!isMenuOpen && (
      ...
      >
        <div>
          ...
          <ul className="text-white flex flex-col font-normal text-center space-y-6 text-2xl">
            ...
            <li className="hover:text-[#FF5D68] w-full duration-300 cursor-pointer">
              <NavLink to={"/mobile-phones"} onClick={handleMenu}>
                {" "}
                Mobile Phones{" "}
              </NavLink>
            </li>
